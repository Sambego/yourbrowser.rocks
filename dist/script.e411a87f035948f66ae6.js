...
exports.Icon = exports.SlideNav = exports.Slide = exports.Header = exports.Container = undefined;
...
var _Slide2 = __webpack_require__(13);

var _Slide3 = _interopRequireDefault(_Slide2);

var _SlideNav2 = __webpack_require__(14);

var _SlideNav3 = _interopRequireDefault(_SlideNav2);

var _Icon2 = __webpack_require__(12);
...
exports.LocationPage = exports.BatteryPage = undefined;
...
var Icon = function Icon(_ref) {
    ...
    var classes = (0, _classnames2.default)('iconic iconic-sm iconic-' + icon + ' ' + color);

    return (0, _preact.h)('i', { className: classes });
};
...
var _slideNav = __webpack_require__(25);
...
// module
exports.push([module.i, ".header__header___1wzW0{position:fixed;z-index:1;top:0;left:0;width:100%;padding:1rem 2rem;background:#253e55}.header__header__title___2aBiL{color:#fff;font-family:Roboto,Helvetica,sans-serif;font-weight:100}", ""]);
...
// module
exports.push([module.i, "@font-face{font-family:Roboto;font-style:normal;font-weight:100;src:local(\"Roboto Thin\"),local(\"Roboto-Thin\"),url(" + __webpack_require__(27) + ") format(\"woff2\"),url(" + __webpack_require__(26) + ") format(\"woff\")}@font-face{font-family:Roboto;font-style:normal;font-weight:300;src:local(\"Roboto Light\"),local(\"Roboto-Light\"),url(" + __webpack_require__(29) + ") format(\"woff2\"),url(" + __webpack_require__(28) + ") format(\"woff\")}@font-face{font-family:Roboto;font-style:normal;font-weight:400;src:local(\"Roboto\"),local(\"Roboto-Regular\"),url(" + __webpack_require__(33) + ") format(\"woff2\"),url(" + __webpack_require__(32) + ") format(\"woff\")}@font-face{font-family:Roboto;font-style:normal;font-weight:700;src:local(\"Roboto Bold\"),local(\"Roboto-Bold\"),url(" + __webpack_require__(31) + ") format(\"woff2\"),url(" + __webpack_require__(30) + ") format(\"woff\")}*{box-sizing:border-box}html{font-size:10px}body{padding:0;font-size:1.6rem;font-family:Roboto,Helvetica,sans-serif}body,h1,h2,h3,p{margin:0}", ""]);
    ...
    (0, _preact.h)(
        ...
        (0, _preact.h)(
            ...
            (0, _preact.h)(
                ...
                null,
                (0, _preact.h)(_Pages.BatteryPage, { path: '/' }),
...
/***/ })
/******/ ]);
//# sourceMappingURL=script.e411a87f035948f66ae6.js.map